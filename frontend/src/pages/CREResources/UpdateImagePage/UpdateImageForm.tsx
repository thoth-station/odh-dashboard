...
export const UpdateImageForm: React.FC = () => {
  ...
  const onSubmit = () => {
    ...
    const image: CREDetails = location.state?.image;
    setIsLoading(true);
  ...
  return (
    <React.Fragment>
      ...
      <ApplicationsPage
        ...
        empty={false}
        title="Update image"
        description="Update an existing CNBI image by changing the image name, description, and annotations"
      >
            ...
            >
              ...
              >
                <Text component="p" className="gutter-bottom">
                  ...
                  Modifying the {activeTabKey} annotations here does not effect the contents of the
                  notebook image.
                </Text>
                <Tabs
